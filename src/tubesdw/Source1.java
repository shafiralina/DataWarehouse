...
public class Source1 extends javax.swing.JFrame {
    ...
    try{
            ...
            String query= "SELECT * FROM KaryawanSTAGGING";
    ...
    try{
            ...
            String query= "SELECT * FROM TimSTAGGING";
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery(query);
    ...
    private void initComponents() {
        ...
        setTitle("Data after Transformation");
        setResizable(false);
        ...
        tabelKaryawan.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "IDKARYAWAN", "NAMA ", "GENDER", "IDTIM", "GAJI ", "IDTIM", "TAHUN MASUK"
            }
        ) {
        ...
        jLabel2.setText("Data after Transformation");
